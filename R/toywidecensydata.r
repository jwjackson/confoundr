...
#'
#' The toy_wide_censY data set contains 1,000 records and 52
...
#'
#'     \item{hsone_0}{censor history at time 0}
#'     \item{hsone_1}{censor history at time 1}
#'     \item{hsone_2}{censor history at time 2}
#'
#'     \item{hsoneg_0}{grouped by p_0, censor history at time 0}
#'     \item{hsoneg_1}{grouped by p_0, censor history at time 1}
#'     \item{hsoneg_2}{grouped by p_0, censor history at time 2}
#'
