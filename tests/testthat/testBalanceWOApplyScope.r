...
test_that("diagnostic 2, no censoring, weight, scope all",{
  ...
  test_that("diagnostic 3, censoring, weight, scope all",{
    ...
    time.exposure <- c(0,1,1,2,2,2,2,2,2,1,1,2,2,2,2,2,2)
    time.covariate <- c(0,0,1,0,1,2,0,1,2,0,1,0,1,2,0,1,2)
    D<-c(0.013243798, 0.016157784, 0.051980229,-0.002844623, 0.015815967,-0.068254599, 0.104956374,-0.076899766, 0.115652754, 0.050064019, 0.092905944,-0.067090916,-0.069583841,-0.170534731,-0.007140200,-0.178699307,-0.075917283)
    SMD<-c(0.028373838, 0.035459449, 0.112330984,-0.006544283, 0.036793102,-0.146820420, 0.219116045,-0.154032969, 0.250922669, 0.106379786, 0.195775471,-0.149630727,-0.139548490,-0.348361620,-0.014358615,-0.398632453,-0.183401291)
    N<-c(1000.3453, 488.2676, 488.2676, 280.6058, 280.6058, 280.6058, 169.4771, 169.4771, 169.4771, 358.0988, 358.0988, 172.7356, 172.7356, 172.7356, 145.8214, 145.8214, 145.8214)
    Nexp<-c(489.18220, 207.59162, 207.59162,  83.51905,  83.51905,  83.51905, 100.29219, 100.29219, 100.29219, 195.29603, 195.29603,  81.27641,  81.27641,  81.27641, 102.34637, 102.34637, 102.34637)
